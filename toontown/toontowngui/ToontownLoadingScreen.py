...
class ToontownLoadingScreen:
    ...
    def __init__(self):
        ...
        self.title = DirectLabel(guiId='ToontownLoadingScreenTitle', parent=self.gui, relief=None, pos=(base.a2dRight/5, 0, 0.235), text='', textMayChange=1, text_scale=0.08, text_fg=(0, 0, .75, 1), text_align=TextNode.ALeft, text_font=ToontownGlobals.getSignFont())
